...
#' Con columna de Pielou pero excluyendo los sitios de 1 especie
...
mean(abundancia[riqueza == min(riqueza)])
#' 
#' Abundancia en el sitio más rico
#' 
abundancia[riqueza == max(riqueza)]
mean(abundancia[riqueza == max(riqueza)])
#' 
