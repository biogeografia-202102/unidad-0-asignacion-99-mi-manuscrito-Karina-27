...
![Análisis de Correlación de Pearson aplicados a índices de diversidad según variables ambientales\label{diversidadalpha}](diversidadalpha.png){widtht = 80%}

![Gráfico de rarefacción para toda la comunidad\label{extrapolacion}](Extrapolacion_mifamilia.png){widtht = 80%}
...
![Correlograma de variables ambientales\label{correlograma}](correlogramavariables.png){widtht = 80%}

![Mapas Lisa generados para las especies de Chrysobalanaceae y elvación media\label{lisamaps}](clusterlisaespecies.png){widtht = 80%}
