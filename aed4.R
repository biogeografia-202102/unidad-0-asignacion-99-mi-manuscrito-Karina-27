...
#' ### Mapa de cuadros, simbología por habitat
mapa_cuadros_habitat <- mapView(
  bci_env_grid,
  layer.name = 'habitat',
  alpha.regions = 0.4,
  map.types = 'OpenTopoMap',
  ...
  leaflet::setView(
    ...
    lat = 9.15097,
    zoom = 15)
mapa_cuadros_habitat
mapa_cuadros_habitat %>% mapshot(file = 'mapa.png') #Genera archivo

#' ### Mapa de cuadros, simbología por quebrada
mapa_cuadros_quebrada <- mapView(
  bci_env_grid,
  layer.name = 'quebrada',
  alpha.regions = 0.4,
  map.types = 'OpenTopoMap',
  ...
  leaflet::setView(
    ...
    lat = 9.15097,
    zoom = 16)
mapa_cuadros_quebrada
mapa_cuadros_quebrada %>% mapshot(file = 'mapa_cuadros_pendiente.png') #Genera archivo